...
const individualSteps = [
  ...
  { num: '03', icon: '📋', title: 'JD 분석', desc: '지원할 공고를 입력하면 회사 정보를 수집하고 매칭 강점과 어필 전략을 제시합니다.' },
...
const headhunterSteps = [
  ...
  { num: '03', icon: '📋', title: 'JD 분석', desc: '클라이언트 JD를 입력하면 적합도를 분석하고 제안 전략을 자동 생성합니다.', category: 'candidate' },
  { num: '04', icon: '📊', title: '클라이언트 제안서 생성', desc: '후보자 강점, JD 분석, 예상 질문이 포함된 제안서를 HTML/PDF로 다운로드합니다.', category: 'candidate' },
  // 시스템 관리 (5단계)

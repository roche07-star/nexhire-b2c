...
const individualFaqs = [
  ...
  },
  {
    ...
    a: 'JD 적합도 분석 후, 이력서 생성 탭에서 분석 결과와 원본 이력서를 선택하면 JD 맞춤 이력서가 자동으로 재작성됩니다. 매칭 강점은 부각하고 부족한 점은 보완하며, 자기소개서도 함께 최적화됩니다. 다운로드 후 항목별 변경사항을 바로 확인할 수 있습니다. PRO는 월 10회, EXPERT는 월 50회 이용 가능합니다.',
  },
  {
    q: '면접 가이드는 무엇을 제공하나요?',
    a: 'JD와 내 이력서를 분석해 예상 면접 질문 10개와 이력서 기반 모범 답변을 생성합니다. 면접관에게 역으로 물어볼 역질문도 3가지(역할/도전/기대 유형) 제공합니다. EXPERT 플랜에서 월 50회 이용 가능하며, 결과는 10일간 저장됩니다.',
  },
  {
    q: '분석 결과는 저장되나요?',
  ...
  {
    q: '내 이력서 데이터는 안전한가요?',
    a: '성명, 연락처, 이메일 등 식별 정보는 AI 분석/이력서 생성 전 자동으로 마스킹 처리되어 외부로 전송되지 않습니다. 직무/경력 내용만 분석에 활용됩니다.',
  },
  {
    q: '현재 회사에 이직 준비 사실이 노출될 위험은 없나요?',
    a: '없습니다. Jobizic은 로그인 후 본인만 접근할 수 있는 개인 분석 공간입니다. 이력서 내 성명/연락처/이메일은 AI 분석 전 자동 마스킹 처리되어 외부로 전송되지 않으며, 분석 결과는 타인과 공유되지 않습니다. 회사 모르게 조용히 준비하셔도 됩니다.',
  },
]

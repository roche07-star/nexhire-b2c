...
const headhunterPlans = [
  ...
  },
  {
    ...
    features: ['이력서 분석 25회/월', 'JD 분석 25회/월', 'JD 적합도 분석 25회/월', '이력서 생성 15회/월', '면접 가이드 15회/월', '제안서 20회/월', '정산 기능 가능', '채용 프로세스 제공', '모든 다운로드 가능'],
    disabled: [],
    btnClass: 'btn-plan-fill',
    btnText: 'Pro 시작하기',
    featured: true,
  },
  {
    ...
    price: '₩49,900',
    desc: '💼 전문 헤드헌터',
    features: ['이력서 분석 50회/월', 'JD 분석 50회/월', 'JD 적합도 분석 50회/월', '이력서 생성 25회/월', '면접 가이드 25회/월', '제안서 50회/월', '정산 기능 가능', '채용 프로세스 제공', '모든 다운로드 가능'],
    disabled: [],
    btnClass: 'btn-plan-outline',
    btnText: 'Expert 신청',
    featured: false,

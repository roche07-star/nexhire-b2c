...
const individualPlans = [
  {
    ...
    features: ['이력서 분석 3회/월', 'JD 적합도 분석 3회/월', '기본 점수 리포트', '커리어 방향 1가지 제안', 'HTML 화면 보기 (다운로드 불가)'],
    disabled: ['이력서 생성', '면접 가이드', 'HTML 리포트 다운로드'],
...
const headhunterPlans = [
  {
    ...
    disabled: ['클라이언트 제안서 생성', '대량 분석', 'Eve (B2B) 연동', 'HTML 리포트 다운로드'],
    btnClass: 'btn-plan-outline',
    btnText: '무료로 시작',
    featured: false,
  },

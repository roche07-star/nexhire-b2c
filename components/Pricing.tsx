...
const headhunterPlans = [
  ...
  },
  {
    ...
    features: ['후보자 분석 20회/월', 'JD 적합도 분석 20회/월', '클라이언트 제안서 자동 생성', '심층 매칭 리포트', '분석 결과 영구 저장', 'HTML/PDF 리포트 다운로드', '후보자 관리 대시보드'],
  ...
  },
  {
    ...
    features: ['후보자 분석 40회/월', 'JD 적합도 분석 40회/월', '클라이언트 제안서 50회/월', '면접 가이드 50회/월', '기업 플랫폼 연동', '프리미엄 템플릿', '대량 분석 (엑셀 업로드)', '팀 협업 기능', 'API 접근 (상담)'],
    disabled: [],
    btnClass: 'btn-plan-outline',
    btnText: 'Expert 신청',
    featured: false,

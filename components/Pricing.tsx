...
const individualPlans = [
  ...
  },
  {
    ...
    features: ['이력서 분석 15회/월', 'JD 적합도 분석 15회/월', '이력서 생성 10회/월', '면접 가이드 10회/월', '심층 점수 리포트', '커리어 방향 3가지 제안', '분석 결과 영구 저장', 'HTML 리포트 다운로드'],
    disabled: [],
  ...
  },
  {
    ...
    features: ['이력서 분석 30회/월', 'JD 적합도 분석 30회/월', '이력서 생성 30회/월', '면접 가이드 50회/월', '심층 점수 리포트', '커리어 방향 3가지 제안', '분석 결과 영구 저장', 'HTML 리포트 다운로드'],
    disabled: [],
    btnClass: 'btn-plan-outline',
    btnText: 'Expert 신청',
    featured: false,

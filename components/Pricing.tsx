...
const plans = [
  ...
  },
  {
    ...
    features: ['이력서 분석 10회/월', 'JD 적합도 분석 15회/월', '심층 점수 리포트', '커리어 방향 3가지 제안', '분석 결과 영구 저장', 'HTML 리포트 다운로드'],
  ...
  },
  {
    ...
    price: '₩49,900',
    desc: '최상위 커리어를 원하는 분',
    features: ['Pro의 모든 기능', '이력서 분석 30회/월', 'JD 적합도 분석 30회/월', '이력서 리라이팅 (출시 시 우선 제공)', '전담 커리어 매니저'],
    disabled: [],
    btnClass: 'btn-plan-outline',
    btnText: 'Expert 신청',
    featured: false,

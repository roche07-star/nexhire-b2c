...
export type Feature = 'analyze' | 'jd' | 'rewrite' | 'interview' | 'proposal' | 'resume' | 'weekly_report' | 'monthly_report'
...
export const PLAN_LIMITS: Record<UserType, Record<Plan, Record<Feature, number>>> = {
  JOBSEEKER: {
    FREE:   { analyze: 3,  jd: 3,  rewrite: 1,  interview: 0, proposal: 0, resume: 1, weekly_report: 2, monthly_report: 0 },
    PRO:    { analyze: 20, jd: 20, rewrite: 10, interview: 10, proposal: 0, resume: 10, weekly_report: 4, monthly_report: 1 },
  ...
  MANAGER: {
    ...
    PRO:    { analyze: 9999, jd: 9999, rewrite: 9999, interview: 9999, proposal: 9999, resume: 9999, weekly_report: 9999, monthly_report: 9999 },
    EXPERT: { analyze: 9999, jd: 9999, rewrite: 9999, interview: 9999, proposal: 9999, resume: 9999, weekly_report: 9999, monthly_report: 9999 },
  },
  SUPER_ADMIN: {
    FREE:   { analyze: 9999, jd: 9999, rewrite: 9999, interview: 9999, proposal: 9999, resume: 9999, weekly_report: 9999, monthly_report: 9999 },
    PRO:    { analyze: 9999, jd: 9999, rewrite: 9999, interview: 9999, proposal: 9999, resume: 9999, weekly_report: 9999, monthly_report: 9999 },

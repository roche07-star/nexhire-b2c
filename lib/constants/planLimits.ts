...
export const PLAN_LIMITS: Record<UserType, Record<Plan, Record<Feature, number>>> = {
  JOBSEEKER: {
    ...
    PRO:    { analyze: 20, jd: 20, rewrite: 15, interview: 10, proposal: 0 },
    EXPERT: { analyze: 50, jd: 50, rewrite: 30, interview: 20, proposal: 0 },
  },
  HEADHUNTER: {
    FREE:   { analyze: 3,  jd: 3,  rewrite: 3,  interview: 0, proposal: 3 },
    PRO:    { analyze: 20, jd: 20, rewrite: 10, interview: 10, proposal: 20 },
    EXPERT: { analyze: 50, jd: 50, rewrite: 25, interview: 25, proposal: 50 },
  },
  MANAGER: {

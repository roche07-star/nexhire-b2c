...
const baseTool: Anthropic.Tool = {
  ...
  input_schema: {
    ...
    properties: {
      ...
      summary: { type: 'string', description: '헤드헌터용 종합 요약 (3-4문장). ①포지셔닝(경력N년차, 직급, 직무) ②핵심강점1가지(수치/프로젝트명) ③커리어패턴+이직동기 ④시장제안방향 또는 리스크. 구체적 사실만 기재, 빈말 금지.' },
      career_paths: {
        type: 'array',
...
헤드헌터가 3초 안에 후보자를 파악할 수 있도록 핵심만 압축. 반드시 3-4문장, 아래 순서대로 작성:

① [포지셔닝] 총 경력 N년차, 현재 [직급] 수준의 [직무] 전문가.
   예: "총 7년차, 시니어급 백엔드 엔지니어."

② [핵심 강점 1가지] 가장 임팩트 있는 성과 또는 기술 스택. 반드시 구체적 수치/프로젝트명 포함.
   예: "카카오페이 결제 시스템 3년 운영, 일 1,000만 건 처리 경험 보유."

③ [커리어 패턴 + 이직 동기] [성장형/전환형/순환형/분산형] 패턴이며, 이직 시그널(재직기간·이직 패턴·직급 변화 분석).
   예: "성장형 커리어이나 최근 1년 재직으로 이직 탐색 추정."

④ [시장 제안 방향] 어떤 포지션에 제안 가능한가? 또는 명확한 리스크 1가지.
   예: "대기업 결제 플랫폼 시니어 포지션 제안 가능. 단, 팀 리드 경험 부재가 리스크."

[금지 사항] "다양한 경험", "뛰어난 역량", "풍부한 경력" 등 빈 말 절대 금지. 날짜·경력 계산 오류 금지.

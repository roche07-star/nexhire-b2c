...
총 경력: ${(a.total_experience_years as number) ?? '미상'}년
학력: ${(a.education as string) || '미상'}
현재 연봉: ${(a.current_salary as string) || '정보 없음'}
...
**[현재 연봉 정보가 없는 경우]**
- 총 경력, 직무, 학력, 커리어 경로 정보를 기반으로 **한국 시장 평균 연봉 범위** 추정
- [참고 기준: 1-3년차 3,000~4,500만원, 4-7년차 4,500~6,500만원, 8-12년차 6,500~9,000만원, 13년차+ 9,000~12,000만원, 학력/직무/산업 고려 ±20%]
- 답변 구조:
  1) 시장 평균 기준 희망 연봉 범위 제시
  2) 회사 제시 조건에 따라 유연하게 협의 가능 명시
- 예시: "제 경력과 역량을 고려했을 때 [시장 평균 범위]만원 수준을 희망하며, 회사 내규와 제시 조건을 종합적으로 고려하여 유연하게 협의 가능합니다."

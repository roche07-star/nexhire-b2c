...
- 직군 특성에 맞게 항목 재편:
  · 기술직: 기술역량 → Safety/품질 → 현장경험 → PM/협업 순
  · 영업/기획직: 핵심성과 → 전문역량 → 커뮤니케이션 순
...
- "더 좋은 기회를 위해", "성장하고 싶어서" 등 모호한 표현 제거
  → 직전 회사에서 얻은 것 + 다음 회사에서 원하는 것의 흐름으로 재작성
- ${jd.company} 이직사유는 단순 동기가 아닌 JD와 연결되는 성장 방향으로 서술
  예) "시운전 중심 → 설계 주도로 역할 확장" / "단일 제품군 → 다양한 산업군 경험"
- 부정적 표현(전 회사 비판, 갈등 암시 등) 완전 배제
- 이직 횟수가 많을 경우: 일관된 성장 스토리 라인으로 연결

**4. 자기소개서 정리**
- 지원동기 / 주요성과 / 입사포부 3단 구조로 명확히 분리
- 지원동기 첫 단락: 핵심 기술역량 + ${jd.position || '지원 포지션'}과의 연결고리 제시
- 주요성과: 정량 수치 포함 대표 프로젝트 1~2건 중심으로 압축
  ("~했습니다" 나열 금지 → 상황-행동-결과(SAR) 구조로)
- 입사포부: 2~3가지로 압축, ${jd.company}의 사업/조직 특성과 연결
...
- "연봉", "복지", "워라밸" 등 처우 관련 표현 전면 제거
- "더 좋은 기회를 위해", "성장하고 싶어서" 등 모호한 표현 제거
- ${jd.company} 이직사유는 JD와 연결되는 성장 방향으로 서술
- 부정적 표현 완전 배제
- 일관된 성장 스토리 라인으로 연결

**4. 자기소개서 단락**
- 지원동기 / 주요성과 / 입사포부 3단 구조로 명확히 분리
- 지원동기: 핵심 기술역량 + ${jd.position || '지원 포지션'}과의 연결고리
- 주요성과: 정량 수치 포함 대표 프로젝트 1~2건 (SAR 구조)
- 입사포부: 2~3가지로 압축, ${jd.company} 사업/조직 특성과 연결
- 주어 반복("저는~") 및 장문 압축
- 구어체 제거: "마지막으로~입니다", "~라고 생각합니다" 남발 금지
- 오탈자 및 비문 전면 교정

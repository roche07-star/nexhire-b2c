...
2. 학력 사항 (표 형식, 구분자 |로 구분)
   형식: |기간|학교명 및 전공|
   예: |2005년 2월 ~ 2011년 2월|한국외국어대학교 태국어과 졸업 [용인]|
3. 업무상 강점 및 핵심 역량 (주요 강점 5개)
4. 경력 사항 (표 형식, 구분자 |로 구분, 총 경력 표시)
   형식: |재직기간|회사명|직무|재직 여부|소재지|
   예: |2016.11 ~ 재직중|애경산업|AGE20'S BM|재직중|서울|
5. 세부 경력사항 (각 회사별로 아래 형식으로 작성, **최신 업무 활동 포함**)
   - 회사명 및 연차: **【 회사명 YYYY년 MM월 ~ 재직 중(또는 YYYY년 MM월)(OO년 OO개월) 직급 】**
   - 회사 정보: 회사 소개, 매출액, 인원 (원본에 있는 경우만, 한 줄로)
   - **담당업무**
   - 상세업무
   - **성과** (숫자가 있는 경우)

...
export default function PipelineClient({ userEmail, userPlan }: PipelineClientProps) {
  ...
  return (
    <div className="zero-nav-spacing" style={{ background: 'var(--bg)', minHeight: '100vh', paddingTop: 80 }}>
      <div style={{ maxWidth: 1600, margin: '0 auto', padding: '32px 20px' }}>
        ...
        <div style={{ marginBottom: 32 }}>
          ...
          <div style={{
            ...
            <p style={{ color: 'var(--text)', fontSize: 13, fontWeight: 600, marginBottom: 6 }}>
              📌 이용 방법
            </p>
            <p style={{ color: 'var(--muted2)', fontSize: 13, lineHeight: 1.6, margin: 0 }}>
              ① <strong>분석&생성</strong> 탭에서 이력서 분석 → ② <strong>📋 JD기반 분석</strong> 완료 → ③ <strong>📊 채용 프로세스 추가</strong> 버튼 클릭
            </p>
          </div>
        </div>

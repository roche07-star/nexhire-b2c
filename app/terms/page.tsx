      ...
      <main className="privacy-page">
        <div className="privacy-container">
          ...
          <div className="privacy-section">
            ...
            <ul>
              <li>재가입 시 FREE 플랜으로 시작하며, 사용량은 0으로 초기화됩니다.</li>
              <li>이용자는 "내 정보" 메뉴에서 기존 데이터 복원을 선택할 수 있습니다.</li>
              <li>복원 시 이전 분석 결과, 저장된 이력서, 미사용 쿠폰이 복원됩니다.</li>
            ...
            <ul>
              <li><strong>플랜 만료 시 미사용 횟수(보너스 횟수 포함)는 소멸되며, 환불되지 않습니다.</strong></li>
              <li>예: PRO 플랜 (월 20회 + 보너스 5회) 중 10회만 사용하고 만료된 경우, 남은 15회는 자동 소멸됩니다.</li>
              <li>플랜 재가입 시 사용 횟수는 0부터 새롭게 시작되며, 새로운 기본 횟수 및 보너스 횟수가 제공됩니다.</li>
              <li>플랜 갱신 시 이전 미사용 횟수는 이월되지 않으며, 갱신된 주기의 횟수(보너스 포함)가 새롭게 제공됩니다.</li>
              <li>보너스 횟수는 프로모션 또는 플랜 구매 시 추가 제공되는 무료 횟수이며, 동일하게 만료 시 소멸됩니다.</li>
